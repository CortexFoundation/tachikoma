...
class LegalizeQnnOpForTachikoma(DFPatternCallback):
    ...
    def __init__(self):
        ...
        pat = self.root # is_op("add")(self.root, self.bias) | self.root  # optional bias
    ...
    def callback(self, pre, post, node_map):
        ...
        dst_zp = (cast_fp(sum_out_zp)
            - cast_fp(sum_lhs_zp) * act_scl
            - cast_fp(sum_rhs_zp) * sum_scl) if sum_src else relay.const(0, dtype="float32")
        """
