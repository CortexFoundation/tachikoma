...
Tachikoma uses DNNL at its core exeuction engine while storing intermediate
computational traces available for export.
...
def make_tachikoma_pattern(op_name, with_bias, with_eltwise):
    ...
    if "conv" in op_name:
        tachikoma_pattern = (pat_name, make_conv_pattern(op_name, with_bias, with_eltwise))
