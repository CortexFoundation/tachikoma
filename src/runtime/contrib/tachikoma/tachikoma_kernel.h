...
extern "C" TVM_DLL void tachikoma_relu(float* data, float* out, int p_N_, int p_C_, int p_H_, int p_W_);
...
extern "C" TVM_DLL void tachikoma_add(float* data, float* weight, float* out, int p_n_, int p_c_,
                                 int p_h_, int p_w_);
